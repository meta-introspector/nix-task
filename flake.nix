        ...
        pkgs = import nixpkgs {
          ...
          overlays = [
            (final: prev: {
              ...
              nix-lazy-trees = (import "${prev.fetchFromGitHub {
                owner = "nixos";
                repo = "nix";
                rev = "0d3a1573304cc66abe423c505c2f751d3b020a66";
                sha256 = "sha256-KMAIegxAXRQqlPnQS1Z477RxGIH9Qtgiwq1aRwLDOPI=";
              }}/default.nix").outputs.packages."${system}".default;
            })
          ];
        };
